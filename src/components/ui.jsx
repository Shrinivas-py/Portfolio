...
export function SectionHeading({ label, title, accent }) {
  return (
    <div className="mb-16 text-center">
      <span className="font-body text-xs font-medium tracking-[0.3em] uppercase text-accent block mb-3">
        {label}
      </span>
...
export function Section({ id, children, className = '' }) {
  ...
  return (
    <section
      id={id}
      ref={ref}
      className={`fade-in-section ${visible ? 'visible' : ''} py-24 px-6 ${className}`}
    >
